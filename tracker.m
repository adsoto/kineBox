...
%   rotation')
%
% Centroid = tracker(vid_path,v,'threshold translation',roi0,tVal,frames,imMean,xMask,yMask) 
...
%
% Centroid = tracker(vid_path,v,'thresh trans advanced',iC,frames,imMean,xMask,yMask) 
% uses advanced algoriothm to return just centroid cooridinates
%   iC - Initial conditions strcuture (with fields for r,x,y,tVal)
%
